...
SYSTEM_PROMPT = os.getenv("SYSTEM_PROMPT", "You make alt-text for images which describes the image in a paragraph, you take instruction from the user prompt on what is in the image")
